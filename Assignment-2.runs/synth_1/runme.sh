...
HD_PWD='C:/Users/dslog/Documents/College/3C7/3C7-Assignment-2/Assignment-2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BoardMap.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BoardMap.tcl
